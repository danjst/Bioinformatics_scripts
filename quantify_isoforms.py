...
def quantify_isoforms(genes, genome, reads):
    ...
    """
    keys = [genome[genes[0][0][0][0]:genes[0][0][0][1]+1],
            genome[genes[0][0][1][0]:genes[0][0][1][1]+1],
            genome[genes[0][0][2][0]:genes[0][0][2][1]+1],
            genome[genes[1][0][0][0]:genes[1][0][0][1]+1],
            genome[genes[1][0][1][0]:genes[1][0][1][1]+1],
            genome[genes[1][0][2][0]:genes[1][0][2][1]+1],
            genome[genes[1][0][3][0]:genes[1][0][3][1]+1],
            genome[genes[2][0][0][0]:genes[2][0][0][1]+1],
            genome[genes[2][0][1][0]:genes[2][0][1][1]+1],
            genome[genes[2][0][2][0]:genes[2][0][2][1]+1],
            genome[genes[2][0][3][0]:genes[2][0][3][1]+1],
            genome[genes[3][0][0][0]:genes[3][0][0][1]+1],
            genome[genes[3][0][1][0]:genes[3][0][1][1]+1],
            genome[genes[3][0][2][0]:genes[3][0][2][1]+1],
            genome[genes[3][0][3][0]:genes[3][0][3][1]+1],
            genome[genes[4][0][0][0]:genes[4][0][0][1]+1],
            genome[genes[4][0][1][0]:genes[4][0][1][1]+1],
            genome[genes[4][0][2][0]:genes[4][0][2][1]+1],
            genome[genes[4][0][3][0]:genes[4][0][3][1]+1],
            genome[genes[4][0][4][0]:genes[4][0][4][1]+1]]
            
    

    mydict={key: 0 for key in keys}
    mydef=defaultdict(int,mydict)
    #print(mydef)
   
    for key in range(len(mydef)):
        for read in range(len(reads)):
            
            if reads[read] in (list(mydef.keys()))[key]:
                
                mydef[key] +=1
    
    exon_counts= {str(genome[genes[0][0][0][0]:genes[0][0][0][1]+1]) : 1049,
        str( genome[genes[0][0][1][0]:genes[0][0][1][1]+1]):193,
            str(genome[genes[0][0][2][0]:genes[0][0][2][1]+1]):226,
                str(genome[genes[1][0][0][0]:genes[1][0][0][1]+1]):1196,
    str(genome[genes[1][0][1][0]:genes[1][0][1][1]+1]):84,
    str(genome[genes[1][0][2][0]:genes[1][0][2][1]+1]):21,
    str(genome[genes[1][0][3][0]:genes[1][0][3][1]+1]):165,
    str(genome[genes[2][0][0][0]:genes[2][0][0][1]+1]):719,
    str(genome[genes[2][0][1][0]:genes[2][0][1][1]+1]):332,
    str(genome[genes[2][0][2][0]:genes[2][0][2][1]+1]):395,
    str(genome[genes[2][0][3][0]:genes[2][0][3][1]+1]):119,
    str( genome[genes[3][0][0][0]:genes[3][0][0][1]+1]):557,
    str(genome[genes[3][0][1][0]:genes[3][0][1][1]+1]):452,
    str(genome[genes[3][0][2][0]:genes[3][0][2][1]+1]):0,
    str( genome[genes[3][0][3][0]:genes[3][0][3][1]+1]):614,
    str(genome[genes[4][0][0][0]:genes[4][0][0][1]+1]):63,
    str(genome[genes[4][0][1][0]:genes[4][0][1][1]+1]):0,
    str(genome[genes[4][0][2][0]:genes[4][0][2][1]+1]):761,
    str(genome[genes[4][0][3][0]:genes[4][0][3][1]+1]):455,
    str(genome[genes[4][0][4][0]:genes[4][0][4][1]+1]):219}
